...
public class Config {
     ...
     */
    public static final String APP_API_URL = "http://s-l-i-m.myjino.ru/ps-store-admin/index.php/";
    public static final String APP_IMAGES_URL = "http://s-l-i-m.myjino.ru/ps-store-admin/uploads/";
    public static final String APP_IMAGES_THUMB_URL = "http://s-l-i-m.myjino.ru/ps-store-admin/uploads/thumbnail/";
