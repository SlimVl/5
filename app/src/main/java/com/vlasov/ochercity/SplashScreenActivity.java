...
import com.vlasov.ochercity.databinding.ActivitySplashScreenBinding;
...
import static com.vlasov.ochercity.Configurations.SHOW_SPLASH_SCREEN_BACKGROUND_IMAGE;

public class SplashScreenActivity extends PSAppCompactActivity {
    ...
    //end for ShopDelivery

    private void initUI(ActivitySplashScreenBinding binding) {
