package com.vlasov.ochercity.viewmodel.comment;
...
import com.vlasov.ochercity.repository.comment.CommentDetailRepository;
...
public class CommentDetailListViewModel extends PSViewModel {
    ...
    private MutableLiveData<com.vlasov.ochercity.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder> sendCommentDetailPostDataObj = new MutableLiveData<>();
    //region Constructor
    ...
    public void setSendCommentDetailPostDataObj(String headerId,
        ...
        if (!isLoading) {
            com.vlasov.ochercity.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder tmpDataHolder = new com.vlasov.ochercity.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder();
