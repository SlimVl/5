package com.vlasov.ochercity.viewmodel.city;
...
import com.vlasov.ochercity.repository.city.CityRepository;
...
public class CityViewModel extends PSViewModel {
    ...
    private MutableLiveData<TmpDataHolder> nextPageCityListObj = new MutableLiveData<>();
