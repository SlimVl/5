...
import com.vlasov.ochercity.repository.comment.CommentRepository;
...
public class CommentListViewModel extends PSViewModel {
    ...
    private MutableLiveData<com.vlasov.ochercity.viewmodel.comment.CommentListViewModel.TmpDataHolder> sendCommentHeaderPostDataObj = new MutableLiveData<>();
    ...
    public void setSendCommentHeaderPostDataObj(String product_id,
        ...
        if (!isLoading) {
            com.vlasov.ochercity.viewmodel.comment.CommentListViewModel.TmpDataHolder tmpDataHolder = new com.vlasov.ochercity.viewmodel.comment.CommentListViewModel.TmpDataHolder();
