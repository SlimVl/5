...
import com.vlasov.helpers.AdvertHelper;
...
import static com.vlasov.ochercity.Configurations.PUBLIC_KEY;
import static com.vlasov.ochercity.Configurations.TEST_DEVICES;
...
public class MainActivity extends PSAppCompactActivity implements IabBroadcastReceiver.IabBroadcastListener {
    ...
    final int NAV_HOME = 0, NAV_BOOKMARKED = 1, NAV_MORE = 3, NAV_INFO = 4, NAV_PREMIUM = 5, NAVSETTINGS = 6, NAV_NEWS = 7, NAV_PROFILE = 8, NAV_LOGOUT = 9, NAV_CATEGORIES = 100, NAV_POLICY = 10, NAV_TERMS = 11, NAV_TIMETABLE = 12 /*NAV_DELIVERY = 13*/;
...
//        getResources().updateConfiguration(configuration, getResources().getDisplayMetrics());
        ...
        //initialise Admob ads with APP unit id
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        switch ((int) drawerItem.getIdentifier()) {
                            ...
                            case NAV_TIMETABLE:
                                ...
                                Bundle bd3 = new Bundle(1);
                                bd3.putInt(TimetableFragment.MODE_KEY, TimetableFragment.RECENT);
                                timetable.setArguments(bd3);
                                changeFragment(timetable);
                                break;
                        }
                        drawer.closeDrawer();
                        return true;
    ...
    public IDrawerItem[] getDrawerItems(List<Category> categories) {
        ...
        drawerItems.add(new SecondaryDrawerItem().withIdentifier(NAV_TIMETABLE).withName(R.string.nav_timetable).withIcon(FontAwesome.Icon.faw_bus));
        //drawerItems.add(new SecondaryDrawerItem().withIdentifier(NAV_DELIVERY).withName(R.string.nav_delivery).withIcon(FontAwesome.Icon.faw_birthday_cake));
