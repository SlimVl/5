...
public class SingleTimetableActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_timetable);
        this.context = this;
        this.activity = this;
        //only portrait
        ...
        if (savedInstanceState != null) {
            ItemId = savedInstanceState.getInt(SingleTimetableActivity.ITEM_KEY);
        } else {
            //get article id from intent (from deep link or prev menu)
            ItemId = Timetable.getIdFromIntent(getIntent(), savedInstanceState);
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            SingleTimetableFragment f = new SingleTimetableFragment();
