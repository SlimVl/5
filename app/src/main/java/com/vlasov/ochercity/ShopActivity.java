...
import com.vlasov.ochercity.databinding.ActivityShopBinding;
...
public class ShopActivity extends PSAppCompactActivity {
    ...
    private void initData() {
        ...
        userViewModel.getLoginUser().observe(this, data -> {
            ...
            if (isLogout) {
                setToolbarText(binding.toolbar, getString(R.string.app__app_name));
//                showBottomNavigation();
                navigationController.navigateToHome(ShopActivity.this);
                showBottomNavigation();
                isLogout = false;
            }
