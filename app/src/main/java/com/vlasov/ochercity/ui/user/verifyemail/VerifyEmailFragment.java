...
import com.vlasov.ochercity.databinding.FragmentVerifyEmailBinding;
...
//            ((ShopActivity) this.getActivity()).binding.toolbar.setBackgroundColor(getResources().getColor(R.color.global__primary));
//            ((ShopActivity) getActivity()).updateMenuIconWhite();
//            ((ShopActivity) getActivity()).updateToolbarIconColor(Color.WHITE);
//
//        }
        ...
        binding.get().changeEmailButton.setOnClickListener(v -> {
            if (getActivity() instanceof ShopActivity) {
                navigationController.navigateToUserRegister((ShopActivity) getActivity());
            } else {
                if(getActivity() != null) {
