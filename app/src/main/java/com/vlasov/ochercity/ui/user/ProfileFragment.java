...
import com.vlasov.ochercity.databinding.FragmentProfileBinding;
import com.vlasov.ochercity.ui.common.DataBoundListAdapter;
import com.vlasov.ochercity.ui.common.PSFragment;
import com.vlasov.ochercity.ui.transaction.list.adapter.TransactionListAdapter;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == Constants.REQUEST_CODE__PROFILE_FRAGMENT
            ...
            if (getActivity() instanceof ShopActivity) {
                ((ShopActivity) getActivity()).setToolbarText(((ShopActivity) getActivity()).binding.toolbar, getString(R.string.profile__title));
                //navigationController.navigateToUserFBRegister((ShopActivity) getActivity());
                navigationController.navigateToUserLogin((ShopActivity) getActivity());
            }
        }
