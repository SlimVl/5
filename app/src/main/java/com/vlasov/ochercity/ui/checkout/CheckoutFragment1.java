...
import com.vlasov.ochercity.databinding.CheckoutFragment1Binding;
...
//    private AutoClearedValue<ProgressDialog> prgDialog;
    ...
    boolean checkShippingPhoneEditText() {
        return binding.get().phoneEditText.getText().toString().isEmpty();
    }
