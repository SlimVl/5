package com.vlasov.ochercity.ui.apploading;
...
import com.vlasov.ochercity.databinding.FragmentAppLoadingBinding;
...
public class AppLoadingFragment extends PSFragment {
    ...
    protected void initData() {
        ...
        if (connectivity.isConnected()) {
            ...
            navigationController.navigateToShopActivity(AppLoadingFragment.this.getActivity());
