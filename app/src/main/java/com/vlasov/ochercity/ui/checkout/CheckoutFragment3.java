package com.vlasov.ochercity.ui.checkout;
...
import com.vlasov.ochercity.databinding.CheckoutFragment3Binding;
...
import com.vlasov.ochercity.viewobject.BasketProductListToServerContainer;
import com.vlasov.ochercity.viewobject.BasketProductToServer;
import com.vlasov.ochercity.viewobject.TransactionHeaderUpload;
    ...
    void sendData() {
        ...
        if (getActivity() != null) {
            ...
            /*if (user.city.id.isEmpty()) {
                ...
                psDialogMsg.show();
                return;
            }else if (user.shippingPhone.isEmpty()) {
                psDialogMsg.showErrorDialog(getString(R.string.phone_one_error_message), getString(R.string.app__ok));
                psDialogMsg.show();
                return;
            }*/
        }
