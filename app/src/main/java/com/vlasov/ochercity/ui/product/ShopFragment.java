package com.vlasov.ochercity.ui.product;
...
import com.vlasov.ochercity.binding.FragmentDataBindingComponent;
import com.vlasov.ochercity.databinding.FragmentMainBinding;
import com.vlasov.ochercity.ui.category.adapter.CategoryIconListAdapter;
import com.vlasov.ochercity.ui.category.adapter.TrendingCategoryAdapter;
import com.vlasov.ochercity.ui.common.DataBoundListAdapter;
import com.vlasov.ochercity.ui.common.PSFragment;
import com.vlasov.ochercity.ui.product.adapter.DiscountListAdapter;
import com.vlasov.ochercity.ui.product.adapter.ProductCollectionRowAdapter;
import com.vlasov.ochercity.ui.product.adapter.ProductHorizontalListAdapter;
import com.vlasov.ochercity.ui.product.adapter.ViewPagerAdapter;
import com.vlasov.ochercity.utils.AutoClearedValue;
import com.vlasov.ochercity.utils.Constants;
import com.vlasov.ochercity.utils.PSDialogMsg;
...
import com.vlasov.ochercity.viewobject.common.Status;
...
public class ShopFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    protected void initUIAndActions() {
        ...
        binding.get().viewAllSliderTextView.setOnClickListener(view -> navigationController.navigateToHomeFilteringActivity(ShopFragment.this.getActivity(), homeFeaturedProductViewModel.productParameterHolder, getString(R.string.menu__featured_product)));

        binding.get().viewAllDiscountTextView.setOnClickListener(view -> navigationController.navigateToHomeFilteringActivity(ShopFragment.this.getActivity(), homeSearchProductViewModel.holder.getDiscountParameterHolder(), getString(R.string.menu__discount)));

        binding.get().viewAllTrendingTextView.setOnClickListener(view -> navigationController.navigateToHomeFilteringActivity(ShopFragment.this.getActivity(), homeTrendingProductViewModel.productParameterHolder, getString(R.string.menu__trending_products)));

        binding.get().viewALlLatestTextView.setOnClickListener(view -> navigationController.navigateToHomeFilteringActivity(ShopFragment.this.getActivity(), homeLatestProductViewModel.productParameterHolder, getString(R.string.menu__latest_product)));

        binding.get().categoryViewAllTextView.setOnClickListener(v -> navigationController.navigateToCategoryActivity(ShopFragment.this.getActivity(), Constants.CATEGORY));
    ...
    protected void initAdapters() {
        ...
        ProductHorizontalListAdapter latestAdapter1 = new ProductHorizontalListAdapter(dataBindingComponent, new ProductHorizontalListAdapter.NewsClickCallback() {
            ...
            public void onClick(Product product) {
                navigationController.navigateToDetailActivity(ShopFragment.this.getActivity(), product);
            }
        ...
        ViewPagerAdapter viewPagerAdapter1 = new ViewPagerAdapter(dataBindingComponent, product -> navigationController.navigateToDetailActivity(ShopFragment.this.getActivity(), product));
        ...
        CategoryIconListAdapter categoryIconListAdapter1 = new CategoryIconListAdapter(dataBindingComponent, category -> {
            ...
            navigationController.navigateToHomeFilteringActivity(ShopFragment.this.getActivity(), categoryViewModel.productParameterHolder, category.name);
        }, this);
...
//        binding.get().categoryIconList.setNestedScrollingEnabled(false);
        ...
        ProductCollectionRowAdapter verticalRowAdapter1 = new ProductCollectionRowAdapter(dataBindingComponent, new ProductCollectionRowAdapter.NewsClickCallback() {
            ...
            public void onViewAllClick(ProductCollectionHeader productCollectionHeader) {
                navigationController.navigateToCollectionProductList(ShopFragment.this.getActivity(), productCollectionHeader.id, productCollectionHeader.name, productCollectionHeader.defaultPhoto.imgPath);
            }
                    ...
                    switch (listResource.status) {
                        ...
                        case LOADING:
                            ...
                            if (listResource.data != null) {
                                ...
                                ShopFragment.this.replaceDiscountList(listResource.data);
                            }
