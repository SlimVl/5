package com.vlasov.ochercity.ui.shop;
...
import com.vlasov.ochercity.databinding.FragmentShopProfileBinding;
...
public class ShopProfileFragment extends PSFragment {
    ...
    private void setAboutUsData(Shop shop) {
        ...
        if (shop.address2.equals("")) {
            ...
            binding.get().address2.setVisibility(View.GONE);
            binding.get().imageView17.setVisibility(View.GONE);
        } else {
            binding.get().address2.setText(shop.address2);
            binding.get().address2.setVisibility(View.VISIBLE);
        ...
        if (shop.address3.equals("")) {
            ...
            binding.get().address3.setVisibility(View.GONE);
            binding.get().imageView18.setVisibility(View.GONE);
        } else {
            binding.get().address3.setText(shop.address3);
            binding.get().address3.setVisibility(View.VISIBLE);
