package com.vlasov.ochercity.ui.notification.list;
...
import com.vlasov.ochercity.databinding.FragmentNotificationListBinding;
import com.vlasov.ochercity.ui.common.DataBoundListAdapter;
import com.vlasov.ochercity.ui.common.PSFragment;
import com.vlasov.ochercity.ui.notification.list.adapter.NotificationListAdapter;
...
public class NotificationListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    private void replaceData(List<com.vlasov.ochercity.viewobject.Noti> notificationList) {
