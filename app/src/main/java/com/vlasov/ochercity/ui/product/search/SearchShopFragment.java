...
import com.vlasov.ochercity.databinding.FragmentSearchShopBinding;
...
public class SearchShopFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    @VisibleForTesting
    private AutoClearedValue<FragmentSearchShopBinding> binding;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        FragmentSearchShopBinding dataBinding = inflate(inflater, R.layout.fragment_search, container, false, dataBindingComponent);
    ...
    protected void initUIAndActions() {
        ...
        binding.get().categorySelectionView.setOnClickListener(view -> navigationController.navigateToSearchActivityCategoryFragment(SearchShopFragment.this.getActivity(), Constants.CATEGORY, catId, subCatId, Constants.NO_DATA, Constants.NO_DATA));
        ...
        binding.get().subCategorySelectionView.setOnClickListener(view -> {
            ...
            if (catId.equals(Constants.NO_DATA)) {
                ...
                navigationController.navigateToSearchActivityCategoryFragment(SearchShopFragment.this.getActivity(), Constants.SUBCATEGORY, catId, subCatId, Constants.NO_DATA, Constants.NO_DATA);
            }
        });
...
//            homeSearchProductViewModel.holder.overall_rating = "";
            ...
            // Set to Intent
            navigationController.navigateToHomeFilteringActivity(SearchShopFragment.this.getActivity(), homeSearchProductViewModel.holder, null);
