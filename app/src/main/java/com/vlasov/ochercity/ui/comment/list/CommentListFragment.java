package com.vlasov.ochercity.ui.comment.list;
...
import com.vlasov.ochercity.databinding.FragmentCommentListBinding;
import com.vlasov.ochercity.ui.comment.list.adapter.CommentListAdapter;
...
public class CommentListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    private void loadData() {
        ...
        LiveData<Resource<List<com.vlasov.ochercity.viewobject.Comment>>> news = commentListViewModel.getCommentListData();
    ...
    private void replaceData(List<com.vlasov.ochercity.viewobject.Comment> commentList) {
