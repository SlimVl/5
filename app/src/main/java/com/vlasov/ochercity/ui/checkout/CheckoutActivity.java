...
import com.vlasov.ochercity.databinding.ActivityCheckoutBinding;
...
import com.vlasov.ochercity.viewobject.holder.TransactionValueHolder;
...
public class CheckoutActivity extends PSAppCompactActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Constants.REQUEST_CODE__SHOP_ACTIVITY
                && resultCode == Constants.RESULT_CODE__RESTART_SHOP_ACTIVITY) {
            ...
            if (number < maxNumber) {
                ...
                if (number == 3) {
                    ...
                    /*if (user.city.id.isEmpty()) {
                        ...
                        psDialogMsg.show();
                        number--;
                    }else if (((CheckoutFragment1)fragment).checkShippingPhoneEditText()) {
