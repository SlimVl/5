...
import com.vlasov.helpers.BillingHelper;
import com.vlasov.helpers.EmptyRecyclerView;
import com.vlasov.helpers.FontManager;
import com.vlasov.helpers.SlideShowAdapter;
...
import static com.vlasov.helpers.FontManager.FONTAWESOME;

/**
 * This activity shows a single place
 */
public class SinglePlaceActivity extends PSAppCompactActivity {
    ...
    IconicsTextView addressView, phoneView, phoneView1, phoneView2, phoneView3, emailView, phoneButton, phoneButton1, phoneButton2, phoneButton3, addressButton, emailButton, webButton, webView;
    TextView addressTitleView, phoneTitleView, phoneTitleView1, phoneTitleView2, phoneTitleView3, emailTitleView, pos, pos_1, pos_2, pos_3, webTitleView;
    LinearLayout addressLayout, phoneLayout, phoneLayout1, phoneLayout2, phoneLayout3, emailLayout, webLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout.LayoutParams localObject = new LinearLayout.LayoutParams(mScreenWidth, (int) (2.0F * (mScreenWidth / 16.0F)));
        ...
        favoriteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (place.isFavorite(context)) {
                    favoriteBtn.setIcon(new IconicsDrawable(activity)
        ...
        price_view = contentView.findViewById(R.id.price_view);
        priceView = contentView.findViewById(R.id.price);
        priceSuffix = contentView.findViewById(R.id.price_suffix);
        dealBtn = contentView.findViewById(R.id.view_deal_button);
        ...
        descriptionView = contentView.findViewById(R.id.descriptionView);
        ...
        addressView = contentView.findViewById(R.id.addressView);
        phoneView = contentView.findViewById(R.id.phoneView);
        phoneView1 = contentView.findViewById(R.id.phoneView1);
        phoneView2 = contentView.findViewById(R.id.phoneView2);
        phoneView3 = contentView.findViewById(R.id.phoneView3);
        emailView = contentView.findViewById(R.id.emailView);
        webView  = contentView.findViewById(R.id.webView);
        addressTitleView = contentView.findViewById(R.id.addressTitleView);
        phoneTitleView = contentView.findViewById(R.id.phoneTitleView);
        phoneTitleView1 = contentView.findViewById(R.id.phoneTitleView1);
        phoneTitleView2 = contentView.findViewById(R.id.phoneTitleView2);
        phoneTitleView3 = contentView.findViewById(R.id.phoneTitleView3);
        pos = contentView.findViewById(R.id.pos);
        pos_1 = contentView.findViewById(R.id.pos_1);
        pos_2 = contentView.findViewById(R.id.pos_2);
        pos_3 = contentView.findViewById(R.id.pos_3);
        emailTitleView = contentView.findViewById(R.id.emailTitleView);
        webTitleView = contentView.findViewById(R.id.webTitleView);
        phoneButton = contentView.findViewById(R.id.phoneButton);
        phoneButton1 = contentView.findViewById(R.id.phoneButton1);
        phoneButton2 = contentView.findViewById(R.id.phoneButton2);
        phoneButton3 = contentView.findViewById(R.id.phoneButton3);
        addressButton = contentView.findViewById(R.id.addressButton);
        webButton = contentView.findViewById(R.id.webButton);
        emailButton = contentView.findViewById(R.id.emailButton);
        phoneLayout = contentView.findViewById(R.id.phoneLayout);
        phoneLayout1 = contentView.findViewById(R.id.phoneLayout1);
        phoneLayout2 = contentView.findViewById(R.id.phoneLayout2);
        phoneLayout3 = contentView.findViewById(R.id.phoneLayout3);
        addressLayout = contentView.findViewById(R.id.addressLayout);
        emailLayout = contentView.findViewById(R.id.emailLayout);
        webLayout = contentView.findViewById(R.id.webLayout);
        ...
        Place.loadSingle(this, ItemId, new Place.onDownloadedListener() {
            ...
            public void onDownloaded(Place propertyLocal) {
                ...
                if (place.deal_link.length() > 0) {
                   ...
                   // priceSuffix.setText(place.price_suffix);
                    dealBtn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent intent = new Intent(context, AppLoadingActivity.class);
                ...
                //set address, email, phone and website
                if (place.address.length() > 0) {
                    ...
                    addressLayout.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("geo:0,0?q=" + place.gpslat + "," + place.gpslng + " (" + place.name + ")"));
                ...
                if (place.telephone1.length() > 0) {
                    phoneView1.setText(place.telephone1);
                    phoneView1.setVisibility(View.VISIBLE);
                    pos_1.setText(place.pos_1);
                    pos_1.setVisibility(View.VISIBLE);
                    phoneTitleView1.setVisibility(View.GONE);
                    phoneButton1.setVisibility(View.VISIBLE);
                    phoneLayout1.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent callIntent = new Intent(Intent.ACTION_DIAL);
                            callIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_NO_USER_ACTION);
                            callIntent.setData(Uri.parse("tel://" + place.telephone1));
                            startActivity(callIntent);
                        }
                    });
                    phoneLayout1.setOnTouchListener(new View.OnTouchListener() {
                        @Override
                        public boolean onTouch(View v, MotionEvent event) {

                            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                                phoneLayout1.setBackgroundColor(ContextCompat.getColor(context, R.color.color_list_background));
                            } else if (event.getAction() == MotionEvent.ACTION_UP || event.getAction() == MotionEvent.ACTION_CANCEL) {
                                phoneLayout1.setBackgroundColor(ContextCompat.getColor(context, R.color.color_card_background));
                            }
                            return false;
                        }
                    });
                }
                if (place.telephone2.length() > 0) {
                    phoneView2.setText(place.telephone2);
                    phoneView2.setVisibility(View.VISIBLE);
                    pos_2.setText(place.pos_2);
                    pos_2.setVisibility(View.VISIBLE);
                    phoneTitleView2.setVisibility(View.GONE);
                    ...
                    phoneLayout2.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            Intent callIntent = new Intent(Intent.ACTION_DIAL);
                            callIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_NO_USER_ACTION);
                            callIntent.setData(Uri.parse("tel://" + place.telephone2));
                            startActivity(callIntent);
                        }
                    });
                    phoneLayout2.setOnTouchListener(new View.OnTouchListener() {
                        @Override
                        public boolean onTouch(View v, MotionEvent event) {

                            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                                phoneLayout2.setBackgroundColor(ContextCompat.getColor(context, R.color.color_list_background));
                            } else if (event.getAction() == MotionEvent.ACTION_UP || event.getAction() == MotionEvent.ACTION_CANCEL) {
                                phoneLayout2.setBackgroundColor(ContextCompat.getColor(context, R.color.color_card_background));
                            }
                            return false;
                        }
                    });
                }
                if (place.telephone3.length() > 0) {
                    phoneView3.setText(place.telephone3);
                    phoneView3.setVisibility(View.VISIBLE);
                    pos_3.setText(place.pos_3);
                    pos_3.setVisibility(View.VISIBLE);
                    phoneTitleView3.setVisibility(View.GONE);
                    phoneButton3.setVisibility(View.VISIBLE);
                    phoneLayout3.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent callIntent = new Intent(Intent.ACTION_DIAL);
                            callIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_NO_USER_ACTION);
                            callIntent.setData(Uri.parse("tel://" + place.telephone3));
                            startActivity(callIntent);
                        }
                    });
                    phoneLayout3.setOnTouchListener(new View.OnTouchListener() {
                        @Override
                        public boolean onTouch(View v, MotionEvent event) {

                            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                                phoneLayout3.setBackgroundColor(ContextCompat.getColor(context, R.color.color_list_background));
                            } else if (event.getAction() == MotionEvent.ACTION_UP || event.getAction() == MotionEvent.ACTION_CANCEL) {
                                phoneLayout3.setBackgroundColor(ContextCompat.getColor(context, R.color.color_card_background));
                            }
                            return false;
                        }
                    });
                ...
                if (place.website.length() > 0) {
                    webView.setText(place.website);
                    webView.setVisibility(View.VISIBLE);
                   // pos.setText(place.pos);
                   // pos.setVisibility(View.VISIBLE);
                    webTitleView.setVisibility(View.GONE);
                    webButton.setVisibility(View.VISIBLE);
                    webLayout.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent webIntent = new Intent(Intent.ACTION_VIEW);
                            webIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_NO_USER_ACTION);
                            webIntent.setData(Uri.parse(place.website));
                            startActivity(webIntent);
                        }
                    });
                    webLayout.setOnTouchListener(new View.OnTouchListener() {
                        @Override
                        public boolean onTouch(View v, MotionEvent event) {

                            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                                webLayout.setBackgroundColor(ContextCompat.getColor(context, R.color.color_list_background));
                            } else if (event.getAction() == MotionEvent.ACTION_UP || event.getAction() == MotionEvent.ACTION_CANCEL) {
                                webLayout.setBackgroundColor(ContextCompat.getColor(context, R.color.color_card_background));
                            }
                            return false;
                        }
                    });
        ...
        //reviews title
        TextView reviews_title = contentView.findViewById(R.id.reviews_title);
        ...
        //load more reviews
        loadMoreBtn = (TextView) findViewById(R.id.load_more_button);
