...
public class Configurations {
    ...
    public static String SERVER_URL = "http://s-l-i-m.myjino.ru/ServerSideCode/";
    ...
    public final static int CATEGORIES_TO_SHOW_IN_NAVIGATION_DRAWER = 5;
    ...
    //For in-app purchase in AndroidManifest.xml also uncomment:
