...
public class GpsLocation {
    ...
    //translation
    String explanationTitle = "Текущее местоположение";
    String explanationDesc = "Разрешите приложению определять ваше местоположение, чтобы оно рассчитывало расстояние до организаций";
    String explanationOK = "OK";
    String explanationCancel = "ОТМЕНА";

    //translation
    String GPSDisabled_explanationTitle = "GPS отключен";
    String GPSDisabled_explanationDesc = "GPS отключен, для правильного использования приложения необходимо включить GPS вашего устройства";
    String GPSDisabled_explanationOK = "Включить GPS";
    String GPSDisabled_explanationCancel = "ОТМЕНА";
